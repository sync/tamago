  ...
  "../../node_modules/@floating-ui/react-dom-interactions/dist/floating-ui.react-dom-interactions.umd.js"(exports2, module2) {
    (function(global2, factory) {
      ...
      const useListNavigation = /* @__PURE__ */ __name(function(_ref, _temp2) {
        ...
        const previousOnNavigate = useEvent2(usePrevious(unstable_onNavigate));
    ...
    var SliderThumb = React3.forwardRef(
      (props, forwardedRef) => {
        ...
        const [size, setSize] = React3.useState(() => {
          const estimatedSize = (0, import_core2.getVariableValue)(getThumbSize(sizeIn).width);
    ...
    function createGroup(verticalDefault) {
      return (0, import_react.forwardRef)((props, ref) => {
        ...
        const children = childrens.map((child, i) => {
          ...
          const props2 = {
            disabled,
            ...(0, import_core2.isTamaguiElement)(child) ? radiusStyles : { style: radiusStyles }
          };
...
var require_TextArea = __commonJS({
  "../../node_modules/tamagui/dist/cjs/views/TextArea.js"(exports2, module2) {
    ...
    var TextAreaFrame = (0, import_core2.styled)(
      import_Input.InputFrame,
      {
        name: "TextArea",
        multiline: true,
        numberOfLines: 4,
